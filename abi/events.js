export const eventsAbi = [
  ...
  { inputs: [], name: "OnlyAccounts", type: "error" },
  {
    anonymous: false,
    inputs: [
      {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "conditionalOrderId", type: "uint256" },
      {
        internalType: "enum IAccount.ConditionalOrderCancelledReason",
        name: "reason",
        type: "uint8",
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "account", type: "address" },
      { internalType: "uint256", name: "conditionalOrderId", type: "uint256" },
      { internalType: "uint256", name: "fillPrice", type: "uint256" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "desiredFillPrice", type: "uint256" },
